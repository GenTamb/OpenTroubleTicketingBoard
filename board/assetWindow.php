...
if(isset($_GET['id']))
{
   ...
   $Asset->getCustomerBy($token);
       ...
       else echo "<title>OpenTroubleTicketing | View Customer : ".$Asset->id[0]." </title>";
       echo "
       <meta charset='utf-8'>
       ...
       echo "
           <div class='row'>
               <div class='col-sm-3 col-md-3 col-lg-3>
                   ...
                   else echo "<span id='customerID'>".$Asset->id[0]."</span>"; echo "    
               </div>
               <div class='col-sm-3 col-md-3 col-lg-3>
                  <label for='customerSurname'>SURNAME</label>
                  <input type='text' class='disabled editable' id='customerSurname' value='".$Asset->surname[0]."'>
               </div>
                <div class='col-sm-3 col-md-3 col-lg-3>
                  <label for='customerName'>NAME</label>
                  <input type='text' class='disabled editable' id='customerName' value='".$Asset->name[0]."'>
               </div>
               <div class='col-sm-3 col-md-3 col-lg-3>
                  <label for='customerType'>TYPE</label>
                  <input type='text' class='disabled editable' id='customerType' value='".$Asset->type[0]."'>
               </div>
           </div>
           <div class='row'>
               <div class='col-sm-3 col-md-3 col-lg-3>
                  <label for='customerSite'>SITE</label>
                  <input type='text' class='disabled editable' id='customerSite' value='".$Asset->site[0]."'>
               </div>
               <div class='col-sm-3 col-md-3 col-lg-3>
